#' Vote count for each party in 2017 
#'
#' The number of votes obtained by each party in each constituency in the 2017 UK General Election.
#'
...
#' }
#' @source \url{https://researchbriefings.files.parliament.uk/documents/CBP-7979/HoC-GE2017-results-by-constituency.csv} \url{https://ckan.publishing.service.gov.uk/dataset/westminster-parliamentary-constituencies-december-2019-boundaries-uk-bfe1/resource/a13d5188-2a5d-4867-a93d-509ea4235299}
"votes17"
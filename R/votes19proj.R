#' Vote count for each party in 2019 as projected to 2024 boundaries 
#'
...
#' }
#' @source \url{https://researchbriefings.files.parliament.uk/documents/CBP-8749/HoC-GE2019-results-by-constituency.csv} \url{https://commonslibrary.parliament.uk/boundary-review-2023-which-seats-will-change/}
"votes19proj"
#' Vote count for each party in 2024 
#'
#' The number of votes obtained by each party in each constituency in the 2024 UK General Election.
#'
#' @format An `sf` dataframe with 650 rows and 35 variables:
#' \describe{
...
#' }
#' @source \url{https://researchbriefings.files.parliament.uk/documents/CBP-10009/HoC-GE2024-results-by-constituency.csv} \url{https://observablehq.com/@jwolondon/uk-election-2024-boundary-data}
"votes24"